...
# If we use linear search to find 98 in the list, we would check each number one by one
# starting from 19. That means we check 19 (not it), 24 (not it),34 (not it), 35 (not it), 
# 67 (not it), and then finally 98. So it would take 6 steps to reach the desired number.
